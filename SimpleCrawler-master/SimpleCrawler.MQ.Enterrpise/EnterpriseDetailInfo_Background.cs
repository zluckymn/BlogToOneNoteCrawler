...
{
    public class EnterpriseDetailInfo_Background:EnterpriseDetailInfoBase
    {
        ...
        public bool TestHashIsTrue()
        {
            ...
            var tableName3IsTrue = tableName3 == "QCCEnterpriseKey_BackgroundInfo_Hash_17";
            var dbIsTrue = dbName == "EnterpriseBackgroundInfo" && dbName2 == "EnterpriseBackgroundInfo";
            return dbIsTrue && tableName == "QCCEnterpriseKey_BackgroundInfo_Hash_48" && tableName2 == "QCCEnterpriseKey_BackgroundInfo_Hash_17";
        }
        override
        public void Start()
        {
         tableName = "QCCEnterpriseKey_BackgroundInfo"; 
         dataBaseName = "EnterpriseBackgroundInfo";
         virtualHost = "mz.core.enterprise_backgroundInfo";
         subscribeId = "backgroundInfo";
            //初始化表与数据库
