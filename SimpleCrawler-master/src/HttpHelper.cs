...
namespace SimpleCrawler
{
    ...
    public class HttpHelper
    {
        ...
        public HttpResult GetHtml(HttpItem item)
        {
            ...
            ///2016.6.3修改自动跳转功能
            if (result.StatusCode != HttpStatusCode.OK && !string.IsNullOrEmpty(result.RedirectUrl))
            {
        ...
        private void SetEncoding(HttpItem item, HttpResult result, byte[] ResponseByte)
        {
            ...
            if (encoding == null)
            {
                ...
                {
                    if (string.IsNullOrEmpty(response.CharacterSet) || response.CharacterSet == "utf8")
                    {
                        encoding = Encoding.UTF8;
                    }
                    else
