...
namespace SimpleCrawler.Demo
{
    ...
    /// 用于城市与区域代码初始化
    /// </summary>
    public class PlantDetailListCrawler : ISimpleCrawler
    {
        ...
        public void SettingInit()//进行Settings.SeedsAddress Settings.HrefKeywords urlFilterKeyWord 基础设定
        {
            ...
            buildingList = dataop.FindAllByQuery(DataTableName, Query.And(Query.NE("isDetailUpdate", 2),Query.EQ("type",1))).ToList();
            //iCPH
