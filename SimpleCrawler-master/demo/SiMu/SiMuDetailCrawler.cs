namespace SimpleCrawler.Demo
{
    ...
    public class SiMuDetailCrawler : ISimpleCrawler
    {
...
#pragma warning disable CS0414 // 字段“SiMuDetailCrawler.huxiu_hash_code”已被赋值，但从未使用过它的值
        private string huxiu_hash_code = "6090caa5f7ef6fe849d98aa30b9b8a22";
#pragma warning restore CS0414 // 字段“SiMuDetailCrawler.huxiu_hash_code”已被赋值，但从未使用过它的值
        ...
        public SiMuDetailCrawler(CrawlSettings _Settings, BloomFilter<string> _filter, DataOperation _dataop)
        {
        ...
        private static BsonDocument SaveProductImg(HtmlNode img, string catName)
        {
            ...
            if ((img != null) && (img.Attributes["src"] != null))
            {
                ...
                {
                    object lockThis = SiMuDetailCrawler.lockThis;
                    lock (lockThis)
                    {
        ...
        public void SettingInit()
        {
            ...
            this.records = this.dataop.FindAllByQuery("SiMu_Project", Query.Exists("isUpdate", false)).SetFields(fields).ToList<BsonDocument>();
