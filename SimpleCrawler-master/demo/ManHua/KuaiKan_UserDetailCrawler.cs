...
namespace SimpleCrawler.Demo
{
    ...
    ///
    ///https://api.kkmh.com/v1/users/90156769 
    ///
    /// </summary>
    public class KuaiKan_UserDetailCrawler : SimpleCrawlerBase
    {
...
#pragma warning restore CS0414 // 字段“PositionDetailCrawler_LiePin.isUpdate”已被赋值，但从未使用过它的值
        ...
        public KuaiKan_UserDetailCrawler(CrawlSettings _Settings, BloomFilter<string> _filter, DataOperation _dataop) : base(_Settings, _filter, _dataop)
        {
            DataTableName = "ManHua_User";//房间
        ...
        public void initialUrl()
        {
            ...
            allHitObjList = FindDataForUpdate(dataTableName: DataTableName, fields:new string[] { "guid" },limit:10000);
            //初始化布隆过滤器
