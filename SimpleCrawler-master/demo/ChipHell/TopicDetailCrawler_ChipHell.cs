...
namespace SimpleCrawler.Demo
{
    ...
    ///
    /// </summary>
    public class TopicDetailCrawler_ChipHell : SimpleCrawlerBase
    {


#pragma warning disable CS0414 // 字段“TopicDetailCrawler_ChipHell.isUpdate”已被赋值，但从未使用过它的值
        bool isUpdate = true;
#pragma warning restore CS0414 // 字段“TopicDetailCrawler_ChipHell.isUpdate”已被赋值，但从未使用过它的值
        ...
        public TopicDetailCrawler_ChipHell(CrawlSettings _Settings, BloomFilter<string> _filter, DataOperation _dataop) : base(_Settings, _filter, _dataop)
        {
...
#pragma warning disable CS0414 // 字段“TopicDetailCrawler_ChipHell.noCountTimes”已被赋值，但从未使用过它的值
        int noCountTimes = 3;
#pragma warning restore CS0414 // 字段“TopicDetailCrawler_ChipHell.noCountTimes”已被赋值，但从未使用过它的值
        /// <summary>
