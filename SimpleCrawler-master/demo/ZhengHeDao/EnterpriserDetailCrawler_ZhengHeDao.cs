...
namespace SimpleCrawler.Demo
{
    ...
    ///
    /// </summary>
    public class EnterpriserDetailCrawler_ZhengHeDao : SimpleCrawlerBase
    {
...
#pragma warning restore CS0414 // 字段“EnterpriserListCrawler_ZhengHeDao.isUpdate”已被赋值，但从未使用过它的值
        ...
        public EnterpriserDetailCrawler_ZhengHeDao(CrawlSettings _Settings, BloomFilter<string> _filter, DataOperation _dataop) : base(_Settings, _filter, _dataop)
        {
