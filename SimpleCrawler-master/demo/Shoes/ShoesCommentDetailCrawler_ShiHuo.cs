...
namespace SimpleCrawler.Demo
{
    ...
    ///
    /// </summary>
    public class ShoesCommentDetailCrawler_ShiHuo : SimpleCrawlerBase
    {


#pragma warning disable CS0414 // 字段“ShoesCommentDetailCrawler_ShiHuo.isUpdate”已被赋值，但从未使用过它的值
        bool isUpdate = true;
#pragma warning restore CS0414 // 字段“ShoesCommentDetailCrawler_ShiHuo.isUpdate”已被赋值，但从未使用过它的值
        ...
        public ShoesCommentDetailCrawler_ShiHuo(CrawlSettings _Settings, BloomFilter<string> _filter, DataOperation _dataop) : base(_Settings, _filter, _dataop)
        {
            DataTableName = "GoodsComment_ShiHuo";//房间
            DataTableCategoryName = "Goods_ShiHuo";//商品
        ...
        {
            allHitObjList = FindDataForUpdate(dataTableName: DataTableCategoryName, fields:new string[] { "guid","curSeriesName","curCatName","curBrandName"});
            //初始化布隆过滤器
...
#pragma warning disable CS0414 // 字段“ShoesCommentDetailCrawler_ShiHuo.noCountTimes”已被赋值，但从未使用过它的值
        int noCountTimes = 3;
#pragma warning restore CS0414 // 字段“ShoesCommentDetailCrawler_ShiHuo.noCountTimes”已被赋值，但从未使用过它的值
        /// <summary>
        ...
        public void DataReceive(DataReceivedEventArgs args)
        {
            ...
            if (items != null)
            {
                ...
                foreach (var item in items)
                {
                    ...
                    bsonDoc.Set("curSeriesName", catInfo.Text("curSeriesName"));
