...
#pragma warning disable CS0414 // 字段“DoctorAPPCrawler.pageSize”已被赋值，但从未使用过它的值
        int pageSize = 20;//24
#pragma warning restore CS0414 // 字段“DoctorAPPCrawler.pageSize”已被赋值，但从未使用过它的值
#pragma warning disable CS0414 // 字段“DoctorAPPCrawler.pageSkipNum”已被赋值，但从未使用过它的值
        int pageSkipNum = 0;
#pragma warning restore CS0414 // 字段“DoctorAPPCrawler.pageSkipNum”已被赋值，但从未使用过它的值
