...
namespace SimpleCrawler.Demo
{
    ...
    ///
    /// </summary>
    public class EnterpriseListCrawler_XiaoLanBen : SimpleCrawlerBase
    {
...
#pragma warning restore CS0414 // 字段“EnterpriseDetailCrawler_XiaoLanBen.isUpdate”已被赋值，但从未使用过它的值
        ...
        public EnterpriseListCrawler_XiaoLanBen(CrawlSettings _Settings, BloomFilter<string> _filter, DataOperation _dataop) : base(_Settings, _filter, _dataop)
        {
        ...
        public void initialUrl()
        {
            ...
            var query = Query.Exists("isDetailUpdate", false);
            ...
            var allHitObjList = dataop.FindLimitFieldsByQuery(DataTableName, query, new MongoDB.Driver.SortByDocument() { { "_id", 1 } }, skipCount, limitCount, new string[] { "guid", "credit_no", "name" });
            ...
            foreach (var hitObj in allHitObjList)
            {
                ...
                var curUrl = $"https://www.meng-you.com.cn:7001/?guid={guid}&keyWord={keyWord}";
        ...
        public void SettingInit()//进行Settings.SeedsAddress Settings.HrefKeywords urlFilterKeyWord 基础设定
        {
            ...
            //Settings.AutoSpeedLimitMinMSecond = 500;
            //Settings.AutoSpeedLimitMinMSecond = 1500;
