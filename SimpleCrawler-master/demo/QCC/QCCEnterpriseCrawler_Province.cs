...
{
    public class QCCEnterpriseCrawler_Province : ISimpleCrawler
    {
        ...
        private const string _DataTableName = "QCCEnterprise_SuZhou";//存储的数据库表明
        ...
        {
            get { return "QCCEnterprise_SuZhou"; }
        ...
        public QCCEnterpriseCrawler_Province(CrawlSettings _Settings, BloomFilter<string> _filter, DataOperation _dataop)
        {
        ...
        public void InitialUrlQueue()
        {
            ...
            for (var page=1;page<= maxPage; page++)
            {
                ...
                var backDetailInfoUrl = string.Format("http://www.jsgsj.gov.cn:58888/province/NoticeServlet.json?QueryExceptionDirectory=true");
                var postData = string.Format("showRecordLine=1&corpName=&tmp=Fri+Aug+19+2016+19%3A12%3A38+GMT%2B0800+(%E4%B8%AD%E5%9B%BD%E6%A0%87%E5%87%86%E6%97%B6%E9%97%B4)&pageNo={0}&pageSize={1}", page, pageSize);
        ...
        public void SettingInit()//进行Settings.SeedsAddress Settings.HrefKeywords urlFilterKeyWord 基础设定
        {
            ...
            // Settings.SimulateCookies = "JSESSIONID=xxlbX2qc6WLXRbqm4bVMZbzmJmvcQ1TGfJzqTH6CLj4lHpS6Y5G0!87969448; BIGipServerpool_gsp=3456018624.25097.0000";
