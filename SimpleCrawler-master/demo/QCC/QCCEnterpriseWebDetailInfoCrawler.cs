...
namespace SimpleCrawler.Demo
{
    ...
    ///
    /// </summary>
    public class QCCEnterpriseWebDetailInfoCrawler : SimpleCrawlerBase
    {
        ...
        public QCCEnterpriseWebDetailInfoCrawler(CrawlSettings _Settings, BloomFilter<string> _filter, DataOperation _dataop) : base(_Settings, _filter, _dataop)
        {
        ...
        public void initialUrl()
        {
            ...
            Console.WriteLine("开始载入数据");
             var query = Query.And(Query.Exists("isDetailUpdate", false), Query.Exists("isDetailUpdate_web", false));
...
#pragma warning restore CS0414 // 字段“EnterpriserDetailCrawler_ZhengHeDao.noCountTimes”已被赋值，但从未使用过它的值
        ...
        public void DataReceive(DataReceivedEventArgs args)
        {
            ...
            if (baseInfNode != null)
            {
                ...
                updateBson.Set("isDetailUpdate_web", 1);
